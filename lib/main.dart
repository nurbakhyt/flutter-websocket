...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _toggleState() {
    setState(() {
      ...
      // _state without calling setState(), then the build method would not be
    ...
    widget.channel.sink.add(jsonEncode({"state": _state}));
  }
          ...
          children: <Widget>[
            StreamBuilder(
              ...
              builder: (context, response) {
                var state = jsonDecode(response.data)['state'];

                return Text(
                  state == 0 ? 'MEDVED' : 'PREVED',
